...
public class LeetCode346 {
    //思路 先深度优先分别找到p和q 到root的路径，相当于单链表，然后找两个链表的公共部分，最后一个公共部分就是最近公共祖先
    List<TreeNode> pList = new ArrayList<>();
    List<TreeNode> qList = new ArrayList<>();

    public static void main(String[] args) {
        LeetCode346 leetCode346 = new LeetCode346();
        leetCode346.lowestCommonAncestor();
